...
#### Step 08:
> Once you complete writing html markup, start writing the CSS code for it. It is a good practice to always use an external stylesheet to style html tags.
